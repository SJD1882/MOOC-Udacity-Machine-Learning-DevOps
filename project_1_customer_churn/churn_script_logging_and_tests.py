# Author - Sebastien
# Date - 2022/05/24
# Runs a few assert statements to test functions from customer
# churn library
...
def test_eda(perform_eda, import_data):
	...
	try:
		...
		logger.error('Testing perform_eda: There should be 5 exploratory graphs in folder "images/eda"')
		raise err
...
def test_encoder_helper(encoder_helper, import_data):
	...
	try:
		...
		logger.error('Testing encoder_helper: Encoding failed. Not all columns are encoded as floats')
...
def test_perform_feature_engineering(perform_feature_engineering, import_data):
	...
	try:
		...
		logger.error('Testing perform_feature_engineering: Failed. There should be 19 features in dataset')
		raise err
...
def test_train_models(train_models, perform_feature_engineering, import_data):
	...
	try:
		...
		logger.error('Testing train_models: Failed. There should be 2 serialized models')
		raise err
